...
async fn run() {
    ...
    let buffer_size = std::mem::size_of_val(input_image.as_raw()) as wgpu::BufferAddress;
    ...
    {
        let (dispatch_with, dispatch_height) = compute_work_group_count((width, height), (8, 8));
    ...
    {
        output_image.save("sushi-grayscale.png").unwrap();
    }
}
